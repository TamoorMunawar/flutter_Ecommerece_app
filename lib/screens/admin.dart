...
import 'package:flutter_ecommerce_app/screens/add_product.dart';
import 'package:flutter_ecommerce_app/screens/orderList.dart';
import 'package:flutter_ecommerce_app/screens/productList.dart';
import 'package:flutter_ecommerce_app/screens/usersList.dart';
            ...
            Expanded(
              child: GridView(
                ...
                children: <Widget>[
                  ...
                  InkWell(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => ProductManager()));
                    },
                    child: Padding(
                      padding: const EdgeInsets.all(18.0),
                      child: Card(
