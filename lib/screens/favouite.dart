...
import 'package:flutter_ecommerce_app/screens/Favoutite%20Checkout.dart';
                            ...
                            builder: (context, productSnap,) {
                              ...
                              if (productSnap.connectionState == ConnectionState
                                ...
                                if (productSnap.hasData)  {
                                  ...
                                  return InkWell(
                                    onTap: () {
                                      Navigator.push(context, MaterialPageRoute(builder: (context)=>FavCheckout()));
                                    },
                                    child: Padding(
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: new IconButton(icon: Icon(Icons.delete), onPressed: ()async{
                                                    ...
                                                    await  Provider.of<AppData>(context,listen: false).deleteFavData(document.id);
...
//print("Total Price = \€${Provider.of<AppData>(context, listen: false).price.toString()} ");
